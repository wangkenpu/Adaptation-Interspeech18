...
if [ $stage -le 3 ]; then
  ...
  (
    ...
    steps/nnet3/get_egs.sh --cmd "$train_cmd" \
      ...
      --srand $srand \
      $train_data_dir $adapt_ali_dir $train_data_dir/egs_kld
    ...
    steps_kld/nnet3/train_rnn.py --stage=$train_stage \
      ...
      --egs.dir="$train_data_dir/egs_kld" \
      --cleanup="false" \
