...
decode_adapt_dir=$lhuc_kld_dir/decode_adapt_hubei_lhuc_kld
...
if [ $stage -le 3 ]; then
  ...
  (
    ...
    steps/nnet3/get_egs.sh --cmd "$train_cmd" \
      ...
      --srand $srand \
      $train_data_dir $adapt_ali_dir $train_data_dir/egs_lhuc_kld
    ...
    steps/nnet3/train_rnn.py --stage=$train_stage \
      ...
      --egs.dir="$train_data_dir/egs_lhuc_kld" \
      --cleanup="false" \
...
if [ $stage -le 4 ]; then
  ...
  (
    ...
    cp $lhuc_kld_dir/lhuc_${data}_$utt_num/10.mdl $decode_dir/final.mdl || exit 1;
